...
public class ArmTest extends RoboDevice {
    ...
    public ArmTest(){
        ...
        m_MasterController = new BasicPID(WiringConnections.ARM_MASTERS_CONTROLLER_ID);
        ...
        m_MasterController.setSlave(m_Slave1Controller, false);
