...
public class Robot extends HuskyRobot {
  ...
  private ArmTestTeleopDecisionMaker m_TeleopDecider = new ArmTestTeleopDecisionMaker();
  private ArmTestAutonomousDecisionMaker m_AutoDecider = new ArmTestAutonomousDecisionMaker();
  ...
  public void robotInit() {
    ...
    //m_TeleopDecider.setArmTestSubSystem(m_ArmTest);
    //m_AutoDecider.setArmTestSubSystem(m_ArmTest);
