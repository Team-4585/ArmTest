...
public final class WiringConnections {
  ...
  public static final int ARM_MASTER_CONTROLLER_ID = 7;
  public static final int ARM_SLAVE_1_CONTROLLER_ID = 8;
  public static final int ARM_MASTERS_CONTROLLER_ID = 9;
}
